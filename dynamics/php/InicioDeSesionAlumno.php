            ...
            if(isset($_POST["username"])&&isset($_POST["pwd"])) //esta linea es para asegurarnos de que no nos lleguen vacios el nombre de usuario y la contraseña 
                {
                    ...
                    if(!filter_var($usuario_limpio, FILTER_VALIDATE_INT)) // este es como un filtro que valida que dentro del usuario no se escriban letras si no solamente numeros 
                        {
